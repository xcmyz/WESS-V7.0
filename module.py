...
class CBHG(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("conv_cat size:", conv_cat.size())
        ...
        conv_projection = self.batchnorm_proj_2(self._conv_fit_dim(
            self.conv_projection_2(conv_projection))) + x
...
if __name__ == "__main__":
    # Test
    test_CBHG = CBHG().to(device)
    test_input = torch.randn(2, 12, 256).to(device)
    test_out = test_CBHG(test_input)
    print(test_out.size())
